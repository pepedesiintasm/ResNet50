...
EXPERIMENT_NAME = "resnet50_stage1_frozen"
...
# Guardamos los nombres de las clases por si luego los quieres usar
...
# Modelo congelado: esta es la versión "normal" sin fine-tuning
...
sensitivity = recall  # mismo valor en binario
...
# pr_thresholds tiene 1 elemento menos que precision/recall
pr_df = pd.DataFrame({
